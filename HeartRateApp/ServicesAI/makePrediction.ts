import scalerParams from "../../front_end/assets/ai/scaler_params.json";
import featureColumns from "../../front_end/assets/ai/feature_columns.json";
...
const makePrediction = async (model: any, userInput: any) => {
  try {
    if (model) {
      ...
      const rawInputVector = constructInputVector(userInput, featureColumns);
