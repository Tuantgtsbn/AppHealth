  ...
  const loadDailyData = async (date) => {
    try {
      ...
      querySnapshot.forEach((doc) => {
        ...
        timeLabels.push(moment(data.timestamp.toDate()).format('HH:mm'));
      });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.dateSelector}>
        ...
        <Text style={styles.dateText}>{selectedDate.format('dddd, DD/MM/YYYY')}</Text>
        <TouchableOpacity onPress={() => changeDate(1)}>
          <Text style={styles.dateNavButton}>》</Text>
        </TouchableOpacity>
      </View>
      ...
      {loading ? (
        ...
        <ScrollView style={styles.scrollView}>
          <View style={styles.chartContainer}>
            ...
            {heartRateData.datasets && heartRateData.datasets[0].data.length > 0 ? (
              <LineChart
                data={heartRateData}
                width={width - 40}
                height={220}
              ...
              <View style={styles.noDataContainer}>
                <Text style={styles.noDataText}>Không có dữ liệu nhịp tim cho ngày này</Text>
              </View>
            )}
          </View>
          ...
          <View style={styles.chartContainer}>
            ...
            {spo2Data.datasets && spo2Data.datasets[0].data.length > 0 ? (
              <LineChart
                data={spo2Data}
                width={width - 40}
                height={220}
              ...
              <View style={styles.noDataContainer}>
                <Text style={styles.noDataText}>Không có dữ liệu SpO2 cho ngày này</Text>
              </View>
            )}
          </View>
        </ScrollView>
